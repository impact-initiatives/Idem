...
#>  4 list_names error    l_country          NA        List 'l_country' is defined…
#>  5 list_names error    l_admin3           NA        List 'l_admin3' is defined …
#>  6 list_names error    l_admin4           NA        List 'l_admin4' is defined …
#>  7 list_names error    l_cluster_id       NA        List 'l_cluster_id' is defi…
#>  8 list_names error    l_yn               NA        List 'l_yn' is defined in t…
#>  9 list_names error    l_yn_dnk_pnta      NA        List 'l_yn_dnk_pnta' is def…
#> 10 list_names error    l_hoh_civil_status NA        List 'l_hoh_civil_status' i…
#> # ℹ 164 more rows
```
